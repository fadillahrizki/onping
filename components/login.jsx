    ...
    <div className="card mt-20 ml-20 border border-2 rounded-lg bg-white text-black block h-[420px]">
        <div className="p-10 px-12">
            ...
            <form className="grid grid-rows-2">
                <div className="py-4">
                    <input type="text" placeholder="Email/Username" name="uname" className="border border-3 rounded-lg p-3 w-[450px]" required/>
                </div>
                <div className="py-4">
                    <input type="password" placeholder="Password" name="pass" className="border border-3 rounded-lg p-3 w-[450px]" required/>
                </div>
